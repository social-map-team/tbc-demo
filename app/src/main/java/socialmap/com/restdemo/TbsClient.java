...
public class TbsClient {
    ...
    private void init(String username, String password) {
        String host = App.sharedPref.getString(ConfigServerActivity.KEY_PREF_SERVER_HOST, App.DEFAULT_SERVER_HOST);
        int port = App.sharedPref.getInt(ConfigServerActivity.KEY_PREF_SERVER_PORT, App.DEFAULT_SERVER_PORT);
